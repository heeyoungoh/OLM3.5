...
function setGridOUGData(){
	...
	result.header = "${menu.LN00024},#master_checkbox,Login ID,Name,English Name,Employee No.,Location,Team,Position,Authority,Email,Company,Tel,Mobile,Type,MemberID,Active,Role Manager,Manager,${menu.LN00190}";
	result.cols = "CHK|LoginID|UserNAME|EnName|EmployeeNum|City|TeamNM|Position|Authority|Email|CompanyNM|TelNum|MTelNum|AuthorityName|MemberID|Active|RoleManagerYN|ManagerYN|ItemCnt";
	result.widths = "50,50,100,80,100,100,100,120,120,80,200,0,100,100,0,0,80,90,80,80";
	result.sorting = "int,int,str,str,str,str,str,str,str,str,str,str,str,int,int,str,str,str,str,str";
	...
	result.data = "UserType=1"
				...
				if($("#mType").val() != '' & $("#mType").val() != null){
					result.data = result.data + "&mType="+$("#mType").val();
				} 
