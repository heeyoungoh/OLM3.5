...
<script type="text/javascript">
	...
	function setConfFrmInit(){
		$("#containerCnf").attr("style", "display:block;width:"+getWidth()+"px;height:"+getHeight()+"px;border: 0;");
	...
	function setScreenResize(){ 
		document.getElementById('containerCnf').style.height=getHeight()+'px';
		document.getElementById('containerCnf').style.width=getWidth()+'px';
	...
	olm.create_tab=function(id,fullId,text,url,isInclude){ 
		...
		if(!olm.url[fullId]){
			...
			mainLayout.attachURL(url+"?cfgCode="+id);
		}else{
			olm.url[fullId]=fullId+"^"+url;
			mainLayout.attachURL(url+"?cfgCode="+id);
		}
...
<div id="contentwrapper" style="position:absolute;">		
		<div id="contentcolumn" >		
			<div class="containerCnf" id="containerCnf" name="containerCnf" scrolling='no'>
