...
<script type="text/javascript"> 
	...
	var lgnUrl="${pageContext.request.contextPath}/login/loginForm.do?mainType=${mainType}&srID=${srID}&wfInstanceID=${wfInstanceID}";
	jQuery(document).ready(function() {
		$('#linkMain').attr('src',lgnUrl);
	});
	...
	function fnReload() {
		var msg = "${WM00104}";		
		var url = "${root}mainpage.do?mainType=${mainType}&srID=${srID}";
		var form = $("form")[0];
		form.action = url;
		form.submit();
	} */
