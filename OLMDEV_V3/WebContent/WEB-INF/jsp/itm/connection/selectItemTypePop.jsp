...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		var data = "&Deactivated=1&category=OJ&languageID=${sessionScope.loginInfo.sessionCurrLangType}";
	...
	function fnSelectItemTypeCode(){ 	
		...
		self.close();
		opener.orgItemTreePop(itemTypeCode);
	}
...
<div class="pdL10 pdR10">
	...
	<span class="btn_pack medium icon"><span class="next"></span>
		<input value="Select" type="button" onclick="fnSelectItemTypeCode()"></span>
	</div>
