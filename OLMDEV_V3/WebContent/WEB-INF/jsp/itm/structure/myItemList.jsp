...
function setTcGridData(){
	...
	tcResult.key = "item_SQL.getMyItemList";
	...
	tcResult.widths = "30,30,30,90,220,100,*,90,90,80,70,60,0,0,0,0,0,0";
	...
	tcResult.data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&statusList=${statusList}" 
				...
				if($("#status").val() != null && $("#status").val() != ""){
			  	...
			  	tcResult.data = tcResult.data + "&changeMgtYN=${changeMgt}&assignmentType=${assignmentType}";
			  	
			  	if("${assignmentType}" != "SUBSCR") {
			  		tcResult.data = tcResult.data + "&roleType=R";
			  	}
			  	else {
			  		tcResult.data = tcResult.data + "&accessRight=R";
			  	}
