...
<body>
	...
	<form name="WorkFlowFrm" id="WorkFlowFrm" action="#" method="post" onsubmit="return false;">
		...
		<table id="newObject" class="tbl_blue01" width="100%;">
			...
			<tr>
				...
				<td  class="last viewtop">
					<input type="text" class="text" id="objWFStepID" name="objWFStepID" value=""   onkeyup="fnOnlyEnNum(this);" onchange="fnOnlyEnNum(this);"/>
				</td>
			</tr>
		...
		<div class="alignBTN">
			<button class="cmm-btn2 mgR10" style="height: 30px;" onclick="saveWorkFlow()"  value="Save">Save</button>	
		</div>
