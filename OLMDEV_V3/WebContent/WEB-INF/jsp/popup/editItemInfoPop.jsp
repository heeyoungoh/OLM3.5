...
$(document).ready(function(){		
	...
	document.getElementById('objectInfoDiv').style.height = (setWindowHeight() - 45)+"px";	
});

function setWindowHeight(){var size = window.innerHeight;var height = 0;if( size == null || size == undefined){height = document.body.clientHeight;}else{height=window.innerHeight;}return height;}

function saveObjInfoMain(){if(confirm("${CM00001}")){var url = "saveObjectInfo.do";	ajaxSubmit(document.objectInfoFrm, url);}}
...
<div class="child_search_head">
	<p><img src="${root}${HTML_IMG_DIR}/category.png">&nbsp;&nbsp;Edit</p>
</div>
