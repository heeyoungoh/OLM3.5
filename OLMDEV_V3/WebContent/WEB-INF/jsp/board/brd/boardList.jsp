...
<script>
	...
	function setGridData(byBtn) {
		...
		result.header = "${menu.LN00024},${menu.LN00002},${menu.LN00131},${menu.LN00212},${menu.LN00390},${menu.LN00030},BoardMgtID,BoardID,${menu.LN00068},ActiveNotice";
		...
		if(projectIDs != undefined && projectIDs != ''){
			result.data = result.data+ "&projectIDs="+projectIDs; 
		}
		return result;
	}
	...
	function gridOnRowSelect(id, ind){
		...
		if(screenType != "Admin"){
			...
			$("#BoardID").val(boardID);
			goDetail("N",boardMgtID, boardID, "", currPage,"${screenType}", projectID, category, categoryIndex, categoryCnt, back);
		}
	}
