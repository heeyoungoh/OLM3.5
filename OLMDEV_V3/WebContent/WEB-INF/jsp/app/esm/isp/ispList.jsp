...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		fnSelect('requestTeam', data, 'getESMSRReqTeamID', '${requestTeam}', 'Select','esm_SQL');	
  		...
  		fnSelect('responseTeam',data, 'getESMSRResponseTeamID', '', 'Select', 'esm_SQL');
	...
	function setGridData(){
		...
		result.header = "${menu.LN00024},SR No.,${menu.LN00002},${menu.LN00027},${menu.LN00014},${menu.LN00025},본부,${menu.LN00021},${menu.LN00033},${srAreaLabelNM1},${menu.LN00004},${menu.LN00093},${menu.LN00221},srID,ReceiptUserID,Status,${menu.LN00223},ReceiptTeamName";
	   //                                                                                 법인,          요청자,               상태,        항목유형,           카테고리                               담당자		 요청일
		result.cols = "SRCode|Subject|StatusName|CompanyName|RequestInfo|ResponseTeamName|ItemTypeCodeNM|SubCategoryNM|SRArea1Name|ReceiptInfo|RegDate|SRDueDate|SRID|ReceiptUserID|Status|SRCompletionDT|ReceiptTeamName";
		result.widths = "0,100,*,120,80,120,120,90,120,120,120,90,90,90,90,90,90,90";
		...
		result.data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}"
						...
						+ "&responseTeamID=" + $("#responseTeam").val()
	...
	<colgroup>
	    ...
	    <col width="17%">
       		...
       		<tr>
		        ...
		        <td class="alignL">	 <select id="responseTeam" Name="responseTeam" style="width:100%">
			        	<option value="">Select</option> 
			        </select>
