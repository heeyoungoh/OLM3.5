...
// 	}
	...
	function gridOnRowSelect(id, ind){
		 if(ind ==3){
			var itemID = gridArea.cells(id, 4).getValue();
			var linkUrl = gridArea.cells(id, 5).getValue();
			var lovCode = gridArea.cells(id, 6).getValue();
			var attrTypeCode = gridArea.cells(id, 7).getValue();
			if(linkUrl != ""){
				fnOpenLink(itemID,linkUrl,lovCode,attrTypeCode);
			}
		}else{
			var elmInstNo=gridArea.cells(id, 11).getValue();
