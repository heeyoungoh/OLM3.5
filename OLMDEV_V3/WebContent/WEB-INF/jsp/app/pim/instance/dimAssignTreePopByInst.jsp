...
<script type="text/javascript">
	...
	$(document).ready(function() {
		initTree();
		setTimeout(function() {fnSetDisableCheckBoxIDs(dimValues);}, 200);	
	});
	...
	function initTree(){
		...
		data += "&s_itemID=${s_itemID}&instanceNo="+instanceNo;
	...
	function addDimension(ids) {		
		var url = "addDimensionForInstance.do";
		var data = "s_itemID=${s_itemID}&ids="+ids;	
		data += "&instanceNo="+instanceNo+"&instanceClass="+instanceClass;
