...
var data = [
         		...
         		items: [
                     {
                         ...
                         value: "Customer Request",          				
         	             html: "<div><img src='cmm/js/dhtmlx/dhtmlxSidebar/codebase/images/icon_sidebar_new.png'/><span class='mgL10'>Customer Request</span></div>"
                     },
                    {
                         id: "srITSP",
                         value: "Dev. Request",
         	                 html: "<div><img src='cmm/js/dhtmlx/dhtmlxSidebar/codebase/images/icon_sidebar_all.png'/><span class='mgL10'>Dev. Request</span></div>"
                     },                
                 ]
             },
             {
	...
	function setPage(id,varFilter){
		...
		if(id === "toggle"){
			...
			url = "esrListMgt.do";
			data =  "srMode=mySR&srStatus=ING&pageNum=1&srType=CSP&scrnType=srRcv&mainType=mySRDtl&multiComp=${multiComp}";
		}else if(id == "srIng"){
			url =  "esrListMgt.do";
			data = "srMode=mySR&srStatus=ING&pageNum=1&srType=${srType}&scrnType=srRcv&mainType=mySRDtl&multiComp=${multiComp}";
		}else if(id == "srITSP"){
			url =  "esrListMgt.do";
			data =  "srMode=mySR&pageNum=1&srType=ITSP&scrnType=srRcv&mainType=mySRDtl&srStatus=ALL&multiComp=${multiComp}";
		}else if(id == "srReq") {
			url =  "esrListMgt.do";
	...
	function setPjtList(){ 
	     ...
	     var target = "pjtFrame";
	     var data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&listSize=20&srMode=mySR&scrnType=mySpace&srType=ITSP";
	     ajaxPage(url, data, target);	
    ...
    function setESRFrame(){ 
        var url = "olmMainEsrList.do";
        var target = "esrFrame";
        var data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&listSize=20&srMode=mySR&scrnType=mySpace&srType=CSP";
        ajaxPage(url, data, target);
    } 
			...
			<div id="mainWrapper">
				<div id="leftDiv">
					...
					<div id="csListDiv" style="height:44%;">
						<div class="secTit">
							<ul>
								<li class="titNM">Development Request</li>
							</ul>
					...
					<div id="esrListDiv">
						<div class="secTit">
							<ul>
								<li class="titNM">Customer Service Request</li>
							</ul>
							<ul class="morebtn" onclick="setPage('srIng')">
								<li>more</li>
							</ul>
