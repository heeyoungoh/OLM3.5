...
//==================================================================================================
	...
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		builder.getRowFormat().setHeightRule(HeightRule.AUTO);
			...
			String AT00003 = StringEscapeUtils.unescapeHtml4(StringUtil.checkNullToBlank(prcListMap.get("Description"))).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
			if ("1".equals(StringUtil.checkNullToBlank(attrRsHtmlMap.get("AT00003")))) { // type이 HTML인 경우
 	 			if(StringUtil.checkNullToBlank(itemInfo.get("toItemDescription")).contains("font-family")){
 	 			...
 	 			builder.getFont().setBold(false);
 	 			builder.write(StringUtil.checkNullToBlank(itemInfo.get("AT00003"))); // 개요 : 내용
 	 		}
			...
			if(i == 0){
				...
				if(outputType.equals("pdf")) fileName += "_" + formatter.format(date) + ".pdf";
				if(outputType.equals("doc")) fileName += "_" + formatter.format(date) + ".docx";
			}
		}
