...
<script>
   ...
   function setGridData(){
      ...
      result.header = "${menu.LN00024},L1,Path,ID,Level,Name,Description,Guideline,Input,Output,Organization,Frequency,Fit/Gap,GAP ID,GAP,Requirement,System Type, IT System,TCODE, Editor,Last Updated";
      result.cols = "L1Code|Path|Code|Level|Name|Description|Guideline|Input|Output|ORG|Frequency|FITGAP|GAPID|GAP|REQ|SYSTP|System|TCODE|EditorNM|LastUpdated";
      result.widths = "30,80,120,80,80,90,180,180,80,80,80,80,80,80,180,180,80,80,100,80,100";
      result.sorting = "str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str";
      result.aligns = "left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,center";
