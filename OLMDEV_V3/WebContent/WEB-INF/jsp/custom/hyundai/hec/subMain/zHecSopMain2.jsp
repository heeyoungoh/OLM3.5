		...
		if(arcCode == "ARC2500") {
			...
			for(var i=0; i< subList.length;i++) {
				...
				if(temp[2] == "0") {
					...
					divText += "<div class='dcontainer'><p><a onClick='"+funcName+"(\""+arcCode+"\",\""+temp[0]+"\");'>"+temp[1]+"</a></p><ul id='"+temp[0]+"' class='open'>";
					l2ItemID = temp[2];
				}
				else if(temp[2] == "2"){
    ...
    function createSubItemDiv2(avg){
        ...
        for(var i=0; i< subList.length;i++) {
			...
			if(temp[2] == "0" && l0Index < 6) {
				divText += "<div id='Div"+temp[0]+"' class='sopContents_box'><div class='title_sub' onClick='setSopL1(\""+arcCode+"\",\""+temp[0]+"\");'>"+temp[1]+"<span>&#43;</span></div>";
				l1ItemID = temp[0];
				l2ItemID = "";
				l1Index = 0;
				l0Index++;
				...
				divText2 += "<div id='Div"+temp[0]+"' class='sopContents_box'><div class='title_sub' onClick='setSopL1(\""+arcCode+"\",\""+temp[0]+"\");'>"+temp[1]+"<span>&#43;</span></div>";
				l1ItemID = temp[0];
				l2ItemID = "";
				l1Index = 0;
				l0Index++;
				...
				divText += "<div class='dcontainer'><p><a onClick='setSopL1(\""+arcCode+"\",\""+temp[0]+"\");'>"+temp[1]+"</a></p><ul id='"+temp[0]+"'>";
				l2ItemID = temp[2];
				l1Index++;
			}
			else if(temp[2] == "1" && l0Index > 6 && l1Index < 6){
				divText2 += "<div class='dcontainer'><p><a onClick='setSopL1(\""+arcCode+"\",\""+temp[0]+"\");'>"+temp[1]+"</a></p><ul id='"+temp[0]+"'>";
				l2ItemID = temp[2];
				l1Index++;
			}
			else if(temp[2] == "2"){
				divText += "<li><span></span><a onclick='setSopL1NoMulti(\""+arcCode+"\",\""+temp[0]+"\");'>&bull;&nbsp;"+temp[1]+"</a></li>";
			}
			
        }

		$("#sopContent1").html(divText);
		$("#sopContent1").attr("style","width:100%;");   
		$("#sopContent2").attr("style","width:100%;");   
