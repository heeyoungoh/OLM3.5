...
// 		    }
			...
			builder.write(String.valueOf(menu.get("LN00070"))); // 생성일
			...
			builder.getParagraphFormat().setAlignment(ParagraphAlignment.CENTER);
		 	...
		 	builder.write(StringUtil.checkNullToBlank(csOwnerTeamNM));
			builder.insertCell();
		   	builder.getCellFormat().setWidth(200);
			builder.getParagraphFormat().setAlignment(ParagraphAlignment.CENTER);
			builder.write(csAuthorNM);
			builder.insertCell();
		   	builder.getCellFormat().setWidth(100);
			builder.getParagraphFormat().setAlignment(ParagraphAlignment.CENTER);
			...
			builder.endTable().setAllowAutoFit(false);
	 		...
	 		if ("N".equals(onlyMap)) {
				...
				builder.getRowFormat().setHeight(30.0);
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00008")));  // 운영원칙
 	 			...
 	 			builder.getFont().setBold(false);
 	 			builder.write(StringUtil.checkNullToBlank(rowPrcData.get("OwnerTeamName"))); //관리조직
	 	 		...
	 	 		builder.getParagraphFormat().setAlignment(ParagraphAlignment.LEFT);
	 	 		builder.getFont().setBold (false);
	 	 		builder.write(StringUtil.checkNullToBlank(rowPrcData.get("Name"))); //담당자
	 	 		...
	 	 		String AT00010 = StringUtil.checkNullToBlank(attrMap.get("AT00010")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
	 	 		if ("1".equals(StringUtil.checkNullToBlank(attrHtmlMap.get("AT00010")))) { // type이 HTML인 경우
	 	 			...
	 	 			builder.getFont().setBold(false);
	 	 			builder.write(StringUtil.checkNullToBlank(attrMap.get("AT00010"))); // 실행부서 : 내용
	 	 		}
	 	 		...
	 	 		String AT00017 = StringUtil.checkNullToBlank(attrMap.get("AT00017")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
	 	 		if ("1".equals(StringUtil.checkNullToBlank(attrHtmlMap.get("AT00017")))) { // type이 HTML인 경우
	 	 			...
	 	 			builder.getFont().setBold(false);
	 	 			builder.write(StringUtil.checkNullToBlank(attrMap.get("AT00017"))); // 유관부서 : 내용
	 	 		}
	 	 		//==================================================================================================	
	 	 		builder.endRow();
	 	 		...
	 	 		builder.getFont().setBold(false);
	 	 		builder.write(StringUtil.checkNullToBlank(rowPrcData.get("LastUpdated"))); // 생성일
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00026")));  // 프록그레스
	 	 		...
	 	 		if ("1".equals(StringUtil.checkNullToBlank(attrHtmlMap.get("AT00026")))) { // type이 HTML인 경우
	 	 			...
	 	 			builder.getFont().setBold(false);
	 	 			builder.write(StringUtil.checkNullToBlank(attrMap.get("AT00026"))); // 프로그레스 : 내용
	 	 		}
	 	 		//==================================================================================================	
	 	 		builder.endRow();
				...
				if (String.valueOf(request.getAttribute("subItemYN")).equals("on")) {
					...
					for(int j=0; j<activityList.size(); j++){
						...
						// 1.ROW : 개요	 	 	 	
			 	 		...
			 	 		String ATVIAT00015 = StringUtil.checkNullToBlank(rowActData.get("AT00015")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00015")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00015);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00015+"</span>");
		 	 			}
			 	 		...
			 	 		String ATVIAT00016 = StringUtil.checkNullToBlank(rowActData.get("AT00016")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00016")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00016);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00016+"</span>");
		 	 			}
			 	 		...
			 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
			 	 		builder.getFont().setBold (true);
			 	 		builder.write(String.valueOf(AttrTypeList.get("AT00013")));  // IT System
			 	 		...
			 	 		String ATVIAT00013 = StringUtil.checkNullToBlank(rowActData.get("AT00013")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00013")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00013);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00013+"</span>");
		 	 			}
			 	 		...
			 	 		String ATVIAT00014 = StringUtil.checkNullToBlank(rowActData.get("AT00014")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00014")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00014);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00014+"</span>");
		 	 			}
			 	 		//==================================================================================================	
			 	 		builder.endRow();
			 	 		...
			 	 		String ATVIAT00009 = StringUtil.checkNullToBlank(rowActData.get("AT00009")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00009")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00009);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00009+"</span>");
		 	 			}
			 	 		...
			 	 		String ATVIAT00010 = StringUtil.checkNullToBlank(rowActData.get("AT00010")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
		 	 			if(StringUtil.checkNullToBlank(rowActData.get("AT00010")).contains("font-family")){
		 	 				builder.insertHtml(ATVIAT00010);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVIAT00010+"</span>");
		 	 			}
			 	 		//==================================================================================================	
			 	 		builder.endRow();
			 	 		...
			 	 		String ATVITAT00006 = StringUtil.checkNullToBlank(rowActData.get("AT00006")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
			 	 		if(StringUtil.checkNullToBlank(rowActData.get("AT00006")).contains("font-family")){	
							builder.insertHtml(ATVITAT00006);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVITAT00006+"</span>");
		 	 			}			
			 	 		//==================================================================================================	
			 	 		builder.endRow();
					   ...
					   /*  builder.insertHtml("<br>");
						...
						builder.getFont().setBold(false);
						 ...
						 ATVITAT00003 = StringUtil.checkNullToBlank(rowActData.get("AT00003")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
						if(StringUtil.checkNullToBlank(rowActData.get("AT00003")).contains("font-family")){	
							builder.insertHtml(ATVITAT00003);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVITAT00003+"</span>");
