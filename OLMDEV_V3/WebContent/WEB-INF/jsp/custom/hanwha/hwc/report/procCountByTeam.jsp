...
<script>
	...
	function setGridData(){ 
		...
		result.header = "주관부서명,L3,L4,L5,구축 진척도(L4기준),#cspan,#cspan,#cspan";
		result.attachHeader1 ="#rspan,#rspan,#rspan,#rspan,N/A,작업 중,완료,승인" ;
		result.widths = "175,70,70,70,70,70,70,70";
		result.sorting = "str,str,str,str,str,str,str,str";
		result.aligns = "left,left,left,left,left,left,left,left";
		result.data = "";
		return result;
	}
	...
	function doSearchList(){
		...
		p_gridArea.loadXML("${root}" + "${mainTeamProcessHWCFilName}");
	}
...
<form name="srRptFrm" id="srRptFrm" action="" method="post" >
	<div id="gridDiv" class="mgB10 mgT5">
		<div id="grdGridArea" style="width:100%;height:536px;"></div>
	</div>
</form>