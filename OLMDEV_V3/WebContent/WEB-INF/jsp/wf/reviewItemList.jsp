...
<script>
	...
	function setGridData(){
		...
		result.cols = "WFDocType|WFInstanceID|Subject|CreatorName|CreatorTeamNM|CreationTime|Status|ProjectID|WFID|StepInstID|ActorID|StepSeq|WFInstanceID|LastSeq|SRID|DocumentID|StatusCode|DocCategory";
		result.widths = "30,120,100,*,100,180,150,100,100,100,50,50,50,50,50,50,0,0";
		...
		result.data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&documentID=${s_itemID}"
	...
	function gridOnRowSelect(id, ind){	
		...
		var docCategory = p_gridArea.cells(id,18).getValue();
		var url = "wfDocMgt.do?";
	...
	function fnRequestReview(){	
		var url = "wfDocMgt.do?ProjectID=${projectID}"
					+ "&s_itemID=${s_itemID}&WFDocURL=custom/sf/wf/createWfDoc_IR&pathSql=${pathSql}&wfDocType=ITM";
		var w = 1400;
		var h = 600;
...
<form name="wfIsntFrm" id="wfIstFrm" action="" method="post"  onsubmit="return false;">
	...
	<div class="countList">
        ...
        <li class="floatR pdR20"> 
    		...
    		<span class="btn_pack medium icon"><span class="save"></span><input value="Request Review" onclick="fnRequestReview()" type="button"></span> 
		</li>
    </div>   
