...
function fnReload() {
	...
	var url = "${root}mainpage.do?mainType=myWF";
	var form = $("form")[0];
	form.action = url;
	form.submit();
}
...
<body><div id="divResult"></div><form id="dfForm" name="dfForm" action="" method="post" target="linkMain"></form>	
 <iframe name="linkMain" id="linkMain" width="100%" height="100%" frameborder="0" scrolling="no" marginwidth="0" marginheight="0"></iframe></body>
</html>