 ...
 */		
	...
	function setGridData(){
		...
		result.title = "${title}";
		result.key = "user_SQL.userProject";
		result.header = "${menu.LN00024},#master_checkbox,Project Code,${menu.LN00028},Work Space,${menu.LN00018},${menu.LN00013},${menu.LN00027},,,${menu.LN00084}";
		result.cols = "CHK|ProjectCode|ProjectName|ParentPjtName|TeamName|CreationTime|StatusName|ProjectID|ChildCount|chkAuth";
		result.widths = "50,50,100,200,150,100,100,50,0,0,100";
		result.sorting = "int,int,str,str,str,str,str,str,int,int,str";
		result.aligns = "center,center,center,left,left,center,center,center,center,center, left";
