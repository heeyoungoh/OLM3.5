...
function fnLogin(isCheck) {
	...
	fnSetCookie();
    var url = "<c:url value='/custom/hyundai/login"+atchUrl+".do'/>";
	...
	<div class="logwrap1">
		<div class="loginarea1">
			...
			<form id="loginForm" name="loginForm" action="#" method="post" onsubmit="return false;">
			    ...
			    <input name="PWD_KEY" id="PWD_KEY"  value="${PWD_KEY}" type="hidden">
			    <input name="iv" id="iv"  value="${iv}" type="hidden">
			    <input name="salt" id="salt"  value="${salt}" type="hidden">
