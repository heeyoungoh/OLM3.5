...
dhtmlXTreeObject.prototype._createItem=function(acheck,itemObject,mode){
	...
	if (this.timgen)
	{  
	td12.style.width="18px"; img.style.height=this.def_img_y; }
	else
	{
		...
		itemObject.span.style.fontFamily =sessionStorage.getItem("DEF_FONT");
...
*/
   dhtmlXTreeObject.prototype._getAllChecked=function(htmlNode,list,mode){
      ...
      if (htmlNode.checkstate==mode && htmlNode.id != this.rootId)
