...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		changeClassCode("CL04002", 'OJ00004');
	...
	function gridInit(){		
		...
		fnSetColType(p_gridArea, 17, "img");
	...
	function setGridData(){
		...
		result.header = "${menu.LN00024},#master_checkbox,클래스, No.,명칭, 기능, 대분류, 중분류, 소분류, 분류체계, ${menu.LN00018}, 작성자, 개정번호, 개정일, Report, ItemID, ClassCode,File, 비고";
		result.cols = "CHK|ClassName|Identifier|ItemName|L1Name|L2Name|L3Name|L4Name|Path|OwnerTeamName|Name|CSVersion|ValidFrom|Report|ItemID|ClassCode|FileIcon|Comment";
		result.widths = "30,30,90,90,*,80,120,120,120,120,80,60,90,90,90,90,60,60,120"; // item 검색
