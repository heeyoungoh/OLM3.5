...
<script>
   ...
   function setGridData(){
      ...
      result.title = "${title}";
      result.key = "custom_SQL.getMBSProcessList";
      result.header = "${menu.LN00024},L1,Path,ID,Level,Name,Description,Guideline,Development ID, IT System,TCODE";
      result.cols = "L1Code|Path|Code|Level|Name|Description|Guideline|DEVID|System|TCODE";
      result.widths = "30,80,120,80,80,90,180,180,80,80,100";
      result.sorting = "str,str,str,str,str,str,str,str,str,str,str,str";
      result.aligns = "left,left,left,left,left,left,left,left,left,left";
