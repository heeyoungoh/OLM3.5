...
<script>
	...
	$(document).ready(function(){	
		...
		if(srMode == "REG"){
			...
			setTimeout(function() { gridInit(); doSearchList("Y"); if(screenType=='srRcv'){gridDownInit();} },1000 );
		}
	});
	...
	function setGridData(onLoad){
		...
		result.header = "${menu.LN00024},SR No.,${menu.LN00002},${menu.LN00014},${menu.LN00027},${menu.LN00025},${srAreaLabelNM1},${srAreaLabelNM2},${menu.LN00033},${menu.LN00004},${menu.LN00093},SR${menu.LN00221},srID,ReceiptUserID,Status,CR${menu.LN00221},${menu.LN00064}";
