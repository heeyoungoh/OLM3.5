...
<script type="text/javascript">
	...
	function initTree(){
		...
		//var option ="${ArcCode}";
		//var option ="";
		var fromItemTypeCode = "${fromItemTypeCode}";
		var toItemTypeCode = "${toItemTypeCode}";
		var data = "fromItemTypeCode="+fromItemTypeCode+"&toItemTypeCode="+toItemTypeCode; 
	...
	function assignItem(){
		$("#rootItemName").val(p_tree.getSelectedItemText());
		$("#rootItemID").val(p_tree.getSelectedItemId());
		$(".popup_div").hide();
		$("#mask").hide();	
	}
