...
/**
 * 공통 서블릿 처리
 * @Class Name : CameUtil.java
 * @Description : Session정보를 Came표기법에 맞게 처리하기 위해 제공한다.
...
public class CamelUtil {
	...
	/**
	 * underscore ('_') 가 포함되어 있는 문자열을 Camel Case ( 낙타등 표기법 - 단어의 변경시에 대문자로 시작하는 형태. 시작은 소문자) 로 변환해주는 utility 메서드
